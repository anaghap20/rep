...
WebDriver driver;
	...
	String excelFilePath = "C:\\Users\\Administrator\\Desktop\\Book6.xlsx";
	...
	String usspss= row.getCell(2).getStringCellValue();

	String cmpass = row.getCell(3).getStringCellValue();
